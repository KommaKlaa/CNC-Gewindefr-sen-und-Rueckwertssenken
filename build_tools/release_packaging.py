...
def render_readme(app_version: str = APP_VERSION) -> str:
    ...
    return (
        ...
        "Das Werkzeug wird an der unteren axialen Werkzeug-Stirnfläche\n"
        "wie ein normales Werkzeug auf der Messdose vermessen.\n"
        "Die Anwendung berücksichtigt anschließend automatisch den\n"
        "werkzeugspezifischen axialen Abstand von der Vermess-Stirnfläche\n"
        "zur ausgeklappten Schneide in +Z-Richtung zur Spindel.\n"
        "\n"
        "HEULE Profile:\n"
        "- BSF-C-1000/050-10.5-23  -> Vermessfläche -> Schneide +8.550 mm\n"
        "- BSF-E-1350/050-16.5-14  -> Vermessfläche -> Schneide +11.400 mm\n"
        "\n"
